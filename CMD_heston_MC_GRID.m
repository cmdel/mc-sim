...
if (NAG==1 || NAG==2)
    ...
    subid =  int32(1);
    stype = int32(1);   % Owen type scrambling of QRVs. 
    ...
    if(NAG==1)
      [iref, state, ifail] = g05yn(genid, stype, int32(idim), iskip, nsdigi, state);
    else
      [iref,ifail]=g05yl(int32(genid), int32(idim),int32(1));
    end
	[VA, iref,ifail] = g05ym(int32(paths),int32(idim),iref); % Create 3 URV
    VA=VA';
end
